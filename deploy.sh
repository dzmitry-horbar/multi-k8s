docker buid -t gorbar/multi-client:latest -t gorbar/multi-client:$SHA -f ./client/Dockerfile ./client
docker buid -t gorbar/multi-server:latest -t gorbar/multi-server:$SHA -f ./server/Dockerfile ./server
docker buid -t gorbar/multi-worker:latest -t gorbar/multi-worker:$SHA -f ./worker/Dockerfile ./worker
